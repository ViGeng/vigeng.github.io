...
citation_conference_title: "ACM SIGCOMM Workshop on Networks for AI Computing (NAIC '26)"
...
@inproceedings{geng2026budget,
  ...
  title     = {Budget-Adaptive Routing: Skipping the Weak When the Strong Answers Anyway},
  booktitle = {ACM SIGCOMM Workshop on Networks for AI Computing (NAIC '26)},
